...
class RequestFactory
{
    ...
    /**
     * For more details and usage information see [docs](https://cp.gamemoney.com/apidoc#card_delete)
     * @param array $data
     * @return Request
     */
    ...
    /**
     * For more details and usage information see [docs](https://cp.gamemoney.com/apidoc#card_add_token)
     * @param array $data
     * @return Request
     */
